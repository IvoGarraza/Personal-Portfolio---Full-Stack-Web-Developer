        ...
        <div>
          <div class="py-8 lg:py-16 px-10 mx-auto max-w-screen-md bg-slate-300 rounded-2xl">
            ...
            <form action="#" class="space-y-8">
              ...
              <button
                type="submit"
                class="py-3 px-5 text-sm font-medium text-center text-white rounded-lg bg-orange-500	 sm:w-fit hover:bg-white hover:text-black focus:ring-4 focus:outline-none focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800"
              >
                Enviar mensaje
              </button>
            </form>
