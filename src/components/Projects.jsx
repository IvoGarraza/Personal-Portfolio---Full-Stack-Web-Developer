...
const Projects = () => {
  return (
    <div className='bg-port__black my-10 w-[100%] h-[100vh] flex flex-row'>
        ...
        <div className='w-[50%] flex flex-col text-center'>
            <p className={`flex-start ${styles.heading2} h-[10%]`}>Some of my works...</p>
            <div className='h-[90%]'>projects</div>
        </div>
    </div>
  )
}
